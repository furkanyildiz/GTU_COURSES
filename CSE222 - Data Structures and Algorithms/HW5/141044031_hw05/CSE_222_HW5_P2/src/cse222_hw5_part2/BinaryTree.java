...
public class BinaryTree < E > implements Iterable<E> {
    ...
    protected class treeIterator implements Iterator<E>{
        ...
        /**
         * Checks the iterator has next or not
         * @return if there is one returns true else not
         */
        @Override
        ...
        /**
         * Returns the next element of Iterator
