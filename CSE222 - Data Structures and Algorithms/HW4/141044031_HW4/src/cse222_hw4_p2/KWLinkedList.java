...
public class KWLinkedList<E> extends AbstractSequentialList<E> {
    ...
    /**
     * Add's the item to the first position of LinkedList.
     * @param item the element to add the list.
     */
    ...
    /**
     * Add's the item to the last position of LinkedList.
     * @param item the element to add the list.
     */
    ...
    /**
     * returns last elements the list
    ...
    */
    ...
    private class KWListIter implements ListIterator<E> {
        ...
        public boolean hasPrevious() {
            return (nextItem == null && size != 0) // Iterator en sonda ise nexItem null gosterecek
                    || nextItem.prev != null;
        }
        ...
        public void add(E obj) {
            if (head == null) { // Add to an empty list.
                ...
                tail.next = newNode; // Step 1 artık sen tail değilsin yeni tail var
        ...
        public void remove() {
            ...
            if(lastItemReturned.next != null) //Son eleman degilse
                lastItemReturned.next.prev = lastItemReturned.prev; //bir sonrakimin previsunu bır öncekim yap
            else{ // Item is the tail
                tail = lastItemReturned.prev;
                if(tail != null) //head değil ise silinmek istenen
                    tail.next = null;
                else //silinmek istenne head ise list artık boş
                    head = null;
            }
...
//https://www.youtube.com/watch?v=q8nnF2sOMHM&index=3&list=PLcfAlTVE_USvoGiy0CqEWCbrWDWKv3ZQl