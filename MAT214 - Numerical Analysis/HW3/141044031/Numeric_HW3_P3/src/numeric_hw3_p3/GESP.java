...
public final class GESP {
    ...
    public ArrayList<Double> gaus(Double[][] matrixx) throws FileNotFoundException, ArithmeticException,Exception {
        
        dimension = matrixx.length;
        matrix = new ArrayList<>(dimension+1);
        ...
        ArrayList<Double> retVal = null;
        try {
            retVal = SolveEquation();
        } catch (Exception ex) {
     ...
     */
    private ArrayList<Double> SolveEquation() throws Exception{
